/*
    Õâ¸ö³ÌĞòÎ  ÔÚwintc »·¾³ÏÂ±àÒë ²¢ÇÒ²âÊÔ² ³É¹¦
    Ö÷ÒªË¼Ïë
    Ï  ÏÈ¶Ô ÒªÊäÈëµÄÎ  ÎÄ¼ş  ½øĞĞÔ¤´¦Àí
      1  ÏÈÉ  É¾³ı  Ô¤´¦Àí ²¿·Ö
      2 ÔÚÉ¾³ı ×¢ÊÍ²¿·Ö ºÍ¶àÓà   »Ø³µ ¿Õ¸ñ
      µÚ¶ş´ó²¿
        1 ÏÈÊä³ö ½ç·û
        2 ÔÚ¶ÔÎÄ¼şµÄ ¹Ø¼ü×Ö »¹ÓĞ ³£Á¿ ½øĞĞ´¦Àí
...
while(str[i]==' ')
{
 i++;
             ...
             /* Õâ¸öÊÇ ¼ÆËã Ê××Ö·ûÊÇ·ñÎª ¿Õ×Ö·û ÊıÁ¿  */
}
...
¹Ø¼ü×ÖÊı×é ÀûÓÃstrcmp£¨£©Õâ¸öº¯Êı× Öğ¸öÉó²é×Ö·û´®
»¹ÓĞ ÕâÑùµÄ
µÚÒ»·ûºÏ  Ç°ÃæÃ»ÓĞ ¡°Õ
 ...
 */
 ...
 int bc=0;/* É¾³ı¶àÓàµÄ¿Õ¸ñ */
 FILE *fp;/* ±£´æ¼´½«ÒªÒª´¦ÀíµÄÎÄ¼şÖ¸Õë */
 FILE *out;  /*  ±£´æµÚÒ»±é´¦ÀíÎÄ¼ş Ö÷Òª´¦ÀíÎª É¾³ı ¶àÓàµÄ ×Ö·û »Ø³µ ×¢ÊÍ ¶àÓà¿Õ¸ñ  */
 FILE   *var;
 FILE *ope;
 char o_file[100]; /*  Êı×éÔÚ ¶Ô ÎÄ¼ş É¾³ıÔ¤´¦Àí²¿·Ö Ê±ÓÃµ½
  */
/*
 ...
 */
 ...
 while(!feof(fp))
 {
  ...
  if(o_file[0]=='#')
{                           /*
del¡ª¡ªbaÕâ¸öÊÇÈ¥³ıÊı×éµÄÇ  Ç°Ãæ¿Õ¸ñµÄ
Ö®ºó¿´Êı×éµÚÒ»¸ö×Ö·ûÊÇ·ñÎª #
 ...
 fputc(' ',out);
  ...
  /*
         ...
         bc=1;  Ô­ÀíÈçÏÂ
           ...
           ·¢ÏÖ Ò Ê×¸ö¿Õ¸ñÖ®ºó  ÈÃÊ×¸ö¿Õ¸ñ ½øÈëÎÄ¼ş £¬ÒÔºóµÄ¿Õ¸ñË ÊäÈë£¬
           ²»ÁË£¬ÖªµÀÓöµ½±ğµÄ×Ö·û ²ÅÄÜÊäÈë
 ...
 while((ch=fgetc(out))!=EOF)
 {
   ...
   /*while(((ch=fgetc(out))!=EOF)|(ch=='='||ch=='>'||ch=='<'||ch=='+'||ch=='-'||ch=='*'||ch=='%'||ch=='/'||ch=='&'||ch=='|'||ch=='!'||ch=='~'))
     ...
     */
     ...
     ²»·Å»ØÖ¸Õë
     ²»ÊÇ Ôò
     ·µ»Ø Ö¸Õë  ÒòÎªÔËËã·ûÖ»ÓĞÁ½¸ö×Ö·û
